	...
	<ul>
		<li>
			...
			<ul class="sub_menu">
				...
				<li><a href="{{url('admin/userinfo')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>玩家信息</a></li>
				<li><a href="{{url('admin/actinfo')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>活动管理</a></li>
			</ul>
		</li>
		<li>
...
<div class="bottom_box">
	CopyRight © 2015. Powered By <a href="http://www.mkbug.com/">http://www.mkbug.com</a>.
</div>
<!--底部 结束-->
